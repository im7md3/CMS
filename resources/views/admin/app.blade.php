...
<head>
    ...
    <style>
        .navbar-sidenav a{color: hsla(0,0%,100%,.5) !important}
        .navbar-sidenav a::after{color: hsla(0,0%,100%,.5) !important}
...
<body class="fixed-nav text-right" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light  bg-dark fixed-top" id="mainNav">
        <div class="container">
            ...
            <ul style="height: 580px !important; margin-top: 62px;"  class="navbar-nav navbar-sidenav h-auto bg-dark" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="المنشورات">
                    ...
                    <ul class="sidenav-second-level bg-dark collapse" id="collapsePosts">
                        <li>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="الأدوار">
                    ...
                    <ul class="sidenav-second-level bg-dark collapse" id="collapseRoles">
                        <li>
                            <a href="#">الأدوار</a>
                        </li>
                        <li>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="">
                    ...
                    <ul class="sidenav-second-level bg-dark collapse" id="collapsePages">
                        <li>
                            <a
